...
total_name1_count = count_true_name1 + count_love_name1
...
total_name2_count = count_true_name2 + count_love_name2

love_score = int(str(total_name1_count + total_name2_count))
